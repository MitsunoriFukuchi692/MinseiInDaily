...
CREATE TABLE IF NOT EXISTS brain_game_records (
  ...
  game       TEXT NOT NULL CHECK (game IN ('kiokusagashi', 'numberguess', 'natsukashi-shiritori', 'kotowaza-anaume', 'showa-crossword')),
...
ALTER TABLE brain_game_records ADD CONSTRAINT brain_game_records_game_check
  CHECK (game IN ('kiokusagashi', 'numberguess', 'natsukashi-shiritori', 'kotowaza-anaume', 'showa-crossword'));
